...
async function autoSave() {
  ...
  try {
    const response = await fetch(apiUrl('/api/tablero/guardarEstadoPartida'), {
      method: 'POST',
...
async function cargarAvatarUsuario() {
  try {
    const response = await fetch(apiUrl('/perfil/me'), {
      credentials: 'include',
      headers: { 'Content-Type': 'application/json' }
    });
...
async function inicializarPartidaNueva() {
  ...
  try {
    const response = await fetch(apiUrl('/api/tablero/crearPartida'), {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      credentials: 'include',
      body: JSON.stringify({
...
async function cargarPartidaYRestaurar(idPartida) {
  ...
  try {
    ...
    const response = await fetch(apiUrl(`/api/tablero/cargarPartida?id=${idPartida}`), {
      credentials: 'include',
      headers: { 'Content-Type': 'application/json' }
    });
...
async function mostrarResultadosFinal() {
  ...
  try {
    ...
    if (ID_PARTIDA) {
      ...
      try {
        const saveResponse = await fetch(apiUrl('/api/tablero/guardarEstadoPartida'), {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
    ...
    if (ID_PARTIDA) {
      ...
      try {
        const response = await fetch(apiUrl('/api/tablero/finalizarPartida'), {
          method: 'POST',
          credentials: 'include',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
